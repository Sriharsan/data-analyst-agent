...
class DataAnalystAgent:
    ...
    def handle_wikipedia_scraping(self, questions, files):
        ...
        try:
            ...
            # Find the main highest-grossing films table - FIXED SEARCH
            table = None
            ...
            # The main table is usually the first large wikitable
            for i, t in enumerate(tables):
                ...
                if len(header_cells) >= 3:  # At least rank, title, gross
                    ...
                    # Look for the main films table (first table with rank/title/gross pattern)
                    ...
                    # Check if this looks like the main films table
            ...
            # Parse table data with robust extraction - FIXED VERSION
            data = []
            ...
            for i, row in enumerate(rows[:50]):  # Process first 50 rows
                ...
                try:
                    # Extract rank (first column) - IMPROVED PARSING
                    ...
                    # Extract film title and year (second column) - ENHANCED
                    title_cell = cells[1]
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port, debug=False), '', film_text).strip()
                    if not film_name:
                        continue
                    
                    # Extract worldwide gross - CRITICAL FIX
                    ...
                    # Look for patterns like "$2.9 billion", "$2,900 million", etc.
                    ...
                    # Extract peak position - FLEXIBLE APPROACH
